...
const pages = [
  {
    ...
    title: 'DECA Glass Tutoring | glassRPG',
    description: 'Get one-on-one DECA glass tutoring from ICDC winner Erika Wu. Build stronger roleplays, sharpen written events, and compete with confidence.'
  },
  {
